package com.huiyouhui.lib.LRecyclerView.recyclerview;
...
import com.huiyouhui.lib.LRecyclerView.view.ArrowRefreshHeader;
 ...
 */
public class LRecyclerViewAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void setAddData(List<T> dataTmp) {
        if (dataTmp != null) {
            adapter.setAddData(dataTmp);
            myRecycleView.refreshComplete();
            notifyDataSetChanged();
        }
    }
