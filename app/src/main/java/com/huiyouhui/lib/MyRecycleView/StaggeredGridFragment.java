package com.huiyouhui.lib.MyRecycleView;
...
//        addData();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (mRecyclerView == null) {
            ...
            mRecyclerView = new MyRecycleView(mContext);
...
//            footerView = LayoutInflater.from(mContext).inflate(R.layout.footer_view, null);
            ...
            // 添加分割线
            mRecyclerView.addItemDecoration(new MyGridLayoutManager.DividerGridItemDecoration(getActivity(), true));
    ...
    public void calHeight() {
        ...
        if (d < 0.25) {
            heights.add(dip2px(mContext == null ? getActivity() : mContext, 30));
        } else if (d < 0.5) {
            heights.add(dip2px(mContext == null ? getActivity() : mContext, 50));
        } else if (d < 0.75) {
            heights.add(dip2px(mContext == null ? getActivity() : mContext, 70));
        } else {
            heights.add(dip2px(mContext == null ? getActivity() : mContext, 100));
        }
    }
